...
<div className='passforg pt-[20px]'>
...
<div className='passforg pt-[5px]'>
 <h3 className='font-medium'>Don't have an account yet?<h3 className='text-[#f7444e] underline font-bold mt-[6px]'><Link to="/sign">sign-in</Link></h3></h3>
 </div>
